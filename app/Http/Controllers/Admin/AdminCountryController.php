...
class AdminCountryController extends Controller
{
    ...
    public function create($venture_capital_id)
    {
        ...
        return view('admin.venture-capital.countries', compact('venture_capital_id', 'venture_capital'));
    }
    ...
    public function store(Request $request, $venture_capital_id)
    {
        try {
            ...
            $country = new Country();
            $country->venture_capital_id = $venture_capital_id;
            $country->name = $request->name;
            $country->value = $request->value;
            $country->save();

            return redirect()->route('admin.venture.show', ['id' => $venture_capital_id])->with('success', 'Country created successfully.');
        } catch (\Exception $e) {
